...
export default function DashboardPage() {
  ...
  const [templateAudience, setTemplateAudience] = useState('+25')
  ...
  const [eventProfileAudience, setEventProfileAudience] = useState('+25')
  ...
  function applyTemplateToEvent(templateId: string) {
    ...
    setAudience(template.audience ?? '+25')
  ...
  function applyEventProfileToEvent(profileId: string) {
    ...
    setAudience(profile.audience ?? '+25')
  ...
  function editEventProfile(profile: any) {
    ...
    setEventProfileAudience(profile.audience ?? '+25')
    const profilePrice = Number(profile.price_from ?? 0)
  ...
  function editTemplate(template: any) {
    ...
    setTemplateAudience(template.audience ?? '+25')
    const templatePrice = Number(template.price_from ?? 0)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (activeProfile) {
      ...
      setAudience(activeProfile.audience ?? '+25')
