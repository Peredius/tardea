export type EventItem = {
  ...
  music: ('Comercial' | 'Electrónica' | 'Reguetón' | 'Pop' | 'Indie' | 'Flamenquito' | 'Remember')[];
...
export const musicTypes = ['Todas', 'Comercial', 'Electrónica', 'Reguetón', 'Pop', 'Indie', 'Flamenquito', 'Remember'];
